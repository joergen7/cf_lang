...
yystate(72, [113|Ics], Line, Tlen, Action, Alen) ->
    yystate(44, Ics, Line, Tlen+1, Action, Alen);
yystate(72, [112|Ics], Line, Tlen, Action, Alen) ->
...
yystate(72, [105|Ics], Line, Tlen, Action, Alen) ->
    yystate(28, Ics, Line, Tlen+1, Action, Alen);
yystate(72, [101|Ics], Line, Tlen, Action, Alen) ->
    yystate(16, Ics, Line, Tlen+1, Action, Alen);
yystate(72, [100|Ics], Line, Tlen, Action, Alen) ->
...
yystate(72, [97|Ics], Line, Tlen, Action, Alen) ->
    yystate(44, Ics, Line, Tlen+1, Action, Alen);
...
yystate(72, [82|Ics], Line, Tlen, Action, Alen) ->
    yystate(67, Ics, Line, Tlen+1, Action, Alen);
yystate(72, [81|Ics], Line, Tlen, Action, Alen) ->
    yystate(44, Ics, Line, Tlen+1, Action, Alen);
yystate(72, [80|Ics], Line, Tlen, Action, Alen) ->
    yystate(71, Ics, Line, Tlen+1, Action, Alen);
yystate(72, [70|Ics], Line, Tlen, Action, Alen) ->
    yystate(45, Ics, Line, Tlen+1, Action, Alen);
yystate(72, [66|Ics], Line, Tlen, Action, Alen) ->
    yystate(29, Ics, Line, Tlen+1, Action, Alen);
yystate(72, [65|Ics], Line, Tlen, Action, Alen) ->
    yystate(44, Ics, Line, Tlen+1, Action, Alen);
yystate(72, [62|Ics], Line, Tlen, Action, Alen) ->
    yystate(13, Ics, Line, Tlen+1, Action, Alen);
yystate(72, [61|Ics], Line, Tlen, Action, Alen) ->
    yystate(9, Ics, Line, Tlen+1, Action, Alen);
yystate(72, [60|Ics], Line, Tlen, Action, Alen) ->
    yystate(5, Ics, Line, Tlen+1, Action, Alen);
yystate(72, [59|Ics], Line, Tlen, Action, Alen) ->
...
yystate(72, [35|Ics], Line, Tlen, Action, Alen) ->
    yystate(62, Ics, Line, Tlen+1, Action, Alen);
...
yystate(72, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 32 ->
    yystate(74, Ics, Line, Tlen+1, Action, Alen);
yystate(72, [C|Ics], Line, Tlen, Action, Alen) when C >= 49, C =< 57 ->
    yystate(6, Ics, Line, Tlen+1, Action, Alen);
yystate(72, [C|Ics], Line, Tlen, Action, Alen) when C >= 67, C =< 69 ->
    yystate(44, Ics, Line, Tlen+1, Action, Alen);
yystate(72, [C|Ics], Line, Tlen, Action, Alen) when C >= 71, C =< 79 ->
    yystate(44, Ics, Line, Tlen+1, Action, Alen);
yystate(72, [C|Ics], Line, Tlen, Action, Alen) when C >= 84, C =< 90 ->
    yystate(44, Ics, Line, Tlen+1, Action, Alen);
yystate(72, [C|Ics], Line, Tlen, Action, Alen) when C >= 102, C =< 104 ->
    yystate(44, Ics, Line, Tlen+1, Action, Alen);
yystate(72, [C|Ics], Line, Tlen, Action, Alen) when C >= 106, C =< 109 ->
    yystate(44, Ics, Line, Tlen+1, Action, Alen);
yystate(72, [C|Ics], Line, Tlen, Action, Alen) when C >= 117, C =< 122 ->
    yystate(44, Ics, Line, Tlen+1, Action, Alen);
...
yystate(71, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 100 ->
    yystate(44, Ics, Line, Tlen+1, 28, Tlen);
yystate(71, [C|Ics], Line, Tlen, _, _) when C >= 102, C =< 120 ->
    yystate(44, Ics, Line, Tlen+1, 28, Tlen);
...
yystate(70, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 33 ->
    yystate(70, Ics, Line, Tlen+1, Action, Alen);
yystate(70, [C|Ics], Line, Tlen, Action, Alen) when C >= 35 ->
    yystate(70, Ics, Line, Tlen+1, Action, Alen);
...
yystate(65, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(44, Ics, Line, Tlen+1, 28, Tlen);
yystate(65, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 109 ->
    yystate(44, Ics, Line, Tlen+1, 28, Tlen);
...
yystate(62, [C|Ics], Line, Tlen, _, _) when C >= 11 ->
    yystate(62, Ics, Line, Tlen+1, 29, Tlen);
...
yystate(60, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 103 ->
    yystate(44, Ics, Line, Tlen+1, 28, Tlen);
yystate(60, [C|Ics], Line, Tlen, _, _) when C >= 105, C =< 122 ->
    yystate(44, Ics, Line, Tlen+1, 28, Tlen);
...
yystate(42, [C|Ics], Line, Tlen, Action, Alen) when C >= 0, C =< 9 ->
    yystate(50, Ics, Line, Tlen+1, Action, Alen);
yystate(42, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 41 ->
    yystate(50, Ics, Line, Tlen+1, Action, Alen);
yystate(42, [C|Ics], Line, Tlen, Action, Alen) when C >= 43, C =< 124 ->
    yystate(50, Ics, Line, Tlen+1, Action, Alen);
...
yystate(40, [105|Ics], Line, Tlen, _, _) ->
    yystate(36, Ics, Line, Tlen+1, 28, Tlen);
...
yystate(28, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(44, Ics, Line, Tlen+1, 28, Tlen);
yystate(28, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 101 ->
    yystate(44, Ics, Line, Tlen+1, 28, Tlen);
yystate(28, [C|Ics], Line, Tlen, _, _) when C >= 103, C =< 109 ->
    yystate(44, Ics, Line, Tlen+1, 28, Tlen);
...
yystate(26, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 41 ->
    yystate(26, Ics, Line, Tlen+1, Action, Alen);
...
yystate(19, Ics, Line, Tlen, _, _) ->
    {28,Tlen,Ics,Line,19};
yystate(18, [47|Ics], Line, Tlen, Action, Alen) ->
...
yystate(18, [C|Ics], Line, Tlen, Action, Alen) when C >= 0, C =< 9 ->
    yystate(26, Ics, Line, Tlen+1, Action, Alen);
yystate(18, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 41 ->
    yystate(26, Ics, Line, Tlen+1, Action, Alen);
yystate(18, [C|Ics], Line, Tlen, Action, Alen) when C >= 43, C =< 46 ->
    yystate(26, Ics, Line, Tlen+1, Action, Alen);
yystate(18, [C|Ics], Line, Tlen, Action, Alen) when C >= 48 ->
    yystate(26, Ics, Line, Tlen+1, Action, Alen);
